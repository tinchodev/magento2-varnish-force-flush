...
namespace Ex6\VarnishPurge\Block\Adminhtml\Cache;
...
class Additional extends CoreAdditional
{
    ...
    {
        return $this->getAuthorization()->isAllowed('Ex6_VarnishPurge::varnish_purge');
    }

    public function getVarnishPurgeUrl(): string
    {
        return $this->getUrl('ex6_varnish/cache/purge');
    }
}
